...
#show the sum of the complete rows
sum(complete_data)

#show the sum of the missing rows
sum(!complete_data)
...
#find the sum of the missing values in the age attribute
...
#extract all records where age > 35 or age < 24
